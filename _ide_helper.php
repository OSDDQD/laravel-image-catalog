...
namespace {
    ...
    class Feed extends \Roumen\Feed\Facades\Feed{
         ...
         * @static 
         */
        public static function add($title, $author, $link, $pubdate, $description, $content = ''){
            \Roumen\Feed\Feed::add($title, $author, $link, $pubdate, $description, $content);
        }
    ...
    class InputProtect extends \Frozennode\XssInput\XssInput{
