...
return array(
	...
	*/
	...
	'custom' => array(
		'captcha' => array(
			'invalid' => 'Неверно введен защитный код.',
		),
        'file' => array(
            'removal_failed' => 'Ошибка при удалении файла. :message',
            'upload_failed' => 'Ошибка при загрузке файла. :message',
        ),
        'image' => array(
            'removal_failed' => 'Ошибка при удалении изображения. :message',
            'upload_failed' => 'Ошибка при загрузке изображения. :message',
        ),
        'userdata' => array(
	...
	*/
	...
	'attributes' => array_merge(include('fields.php'), [
