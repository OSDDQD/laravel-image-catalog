...
<body>
    <div class="container vcenter" style="width: 450px;">
        <div class="panel panel-default" style="margin:auto;">
            <div class="panel-heading"><strong>{{ Lang::get('client.password_reset_complete') }}</strong></div>
            <div class="panel-body">
                ...
                {{ Form::open(array('route' => array('password.update', $token))) }}
                    ...
                    <div class="input-group" style="margin-bottom:5px;">
                        {{ Form::password('password', ['class' => 'form-control', 'placeholder' => Lang::get('forms.labels.password_confirmation')]) }}
                        <span class="input-group-addon"><i class="fa fa-lock fa-fw"></i></span>
                        {{ $errors->first('password', '<div class="help-block has-error">:message</div>')}}
